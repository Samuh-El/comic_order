//! Componente modal para edición de metadatos de cómics.
    ...
    let overlay = container(
        container(
            column![
                // Cabecera
                row![
                    text("Editar Cómic").size(20).color(iced::Color::WHITE),
                ...
                column![
                    ...
                    text_input("Título del cómic", &form.title)
                ...
                column![
                    ...
                    text_input("Nombre de la saga o arco", &form.saga)
