...
if (-not (Test-Path $paths.FEATURE_DIR -PathType Container)) {
    ...
    $specifyCommand = Format-SpecKitCommand -CommandName 'speckit.specify'
...
if (-not (Test-Path $paths.IMPL_PLAN -PathType Leaf)) {
    ...
    $planCommand = Format-SpecKitCommand -CommandName 'speckit.plan'
...
if ($RequireTasks -and -not (Test-Path $paths.TASKS -PathType Leaf)) {
    ...
    $tasksCommand = Format-SpecKitCommand -CommandName 'speckit.tasks'
